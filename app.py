...
def main():
    ...
    # Method 1: Try to get config using the function (handles both secrets and env vars)
    try:
        endpoint, api_key, deployment, api_version = get_azure_openai_config()
        config.AZURE_OPENAI_ENDPOINT = endpoint
        config.AZURE_OPENAI_API_KEY = api_key
        ...
        # Credentials not found - will show error below
        pass
    except Exception as e:
        # Other error - will show error below
        pass
